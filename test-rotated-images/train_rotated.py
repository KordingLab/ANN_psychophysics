...
# parameters for Fisher info calculation
parser.add_argument("--layer", help="which layer of VGG the model was trained to decode from. For VGG options are 4, 9, 16, 23, 30",
                        type=int,
                        default = 4)
parser.add_argument("--delta",
                        ...
                        type = float,
                        default = 1e-3)
parser.add_argument("--fisher_freq",
                        help = "How many times per epoch",
                        type = int,
                        default = 5)
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    fisher_freq = len(train_loader) // args.fisher_freq
